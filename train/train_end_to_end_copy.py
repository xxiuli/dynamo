...
ADAPTER_WEIGHT_PATHS = [
    os.path.join(BASE_DIR, "lora_checkpoints", "lora_task0.pth"),
    os.path.join(BASE_DIR, "lora_checkpoints", "lora_task1.pth"),
    os.path.join(BASE_DIR, "lora_checkpoints", "lora_task2.pth")
]
